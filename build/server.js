...
/***/ "./app/assets/css/individualSite.css":
/*!*******************************************!*\
  !*** ./app/assets/css/individualSite.css ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./app/assets/images/contentImage.jpg":
/*!********************************************!*\
  !*** ./app/assets/images/contentImage.jpg ***!
  \********************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "contentImage.jpg";
...
module.exports = __webpack_require__.p + "home_icon.png";
...
/***/ "./app/assets/images/trendingscan.png":
/*!********************************************!*\
  !*** ./app/assets/images/trendingscan.png ***!
  \********************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "trendingscan.png";

/***/ }),

/***/ "./app/components/Ad.js":
/*!******************************!*\
  !*** ./app/components/Ad.js ***!
  \******************************/
/*! no static exports found */
...
__webpack_require__(/*! ./../assets/css/ad.css */ "./app/assets/css/ad.css");
...
var _PrivacyPolicy = __webpack_require__(/*! ./PrivacyPolicy */ "./app/components/PrivacyPolicy.js");

var _PrivacyPolicy2 = _interopRequireDefault(_PrivacyPolicy);

var _IndividualBlog = __webpack_require__(/*! ./IndividualBlog */ "./app/components/IndividualBlog.js");

var _IndividualBlog2 = _interopRequireDefault(_IndividualBlog);
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_reactHelmet.Helmet, {
					...
					meta: [{ name: "description", content: "Trendingscan - Top Trending Searches" }, { name: "viewport", content: "width=device-width, initial-scale=1" }],
					link: [{ rel: "icon shortcut", href: '/build/favicon.ico' }, { rel: "stylesheet", type: "text/css", href: 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css', crossorigin: 'anonymous' }]
				}),
				_react2.default.createElement(
					_reactRouterDom.Switch,
					null,
					_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _Home2.default }),
					_react2.default.createElement(_reactRouterDom.Route, { path: '/privacy-policy', exact: true, component: _PrivacyPolicy2.default }),
					_react2.default.createElement(_reactRouterDom.Route, { path: '/desc/:id', exact: true, strict: true, component: _IndividualBlog2.default }),
					_react2.default.createElement(_reactRouterDom.Redirect, { from: '/', to: '/', strict: true })
				)
			);
		}
	}]);
...
__webpack_require__(/*! ./../assets/css/blog.css */ "./app/assets/css/blog.css");

var _contentImage = __webpack_require__(/*! ./../assets/images/contentImage.jpg */ "./app/assets/images/contentImage.jpg");

var _contentImage2 = _interopRequireDefault(_contentImage);

var _htmlReactParser = __webpack_require__(/*! html-react-parser */ "./node_modules/html-react-parser/index.js");
...
var Blogcontent = function (_Component) {
    ...
    function Blogcontent() {
        ...
        var _this = _possibleConstructorReturn(this, (Blogcontent.__proto__ || Object.getPrototypeOf(Blogcontent)).call(this));
        ...
        _this.moreresults = _this.moreresults.bind(_this);
    ...
    _createClass(Blogcontent, [{
        key: 'sortByCity',
        value: function sortByCity(cityname) {
            var _this2 = this;
            ...
            fetch('/sitesbycities/' + cityname + '/' + this.state.resultcount, { headers: { //http://localhost:3001/
                ...
                if (_this2.is_mounted) {
                    _this2.setState({ error: false, loader: false, contents_in_view: data }, function () {
                        _this2.checknextsets(cityname);
                    });
                }
            }).catch(function (err) {
                if (_this2.is_mounted) {
                    _this2.setState({ error: true, loader: false, contents_in_view: err });
                }
            });
        }
    }, {
        key: 'checknextsets',
        value: function checknextsets(cityname) {
            var _this3 = this;
            ...
            fetch('/sitesbycities/' + cityname + '/' + (parseInt(this.state.resultcount, 10) + 10), { headers: {
                ...
                var previousstate = _this3.state;
                if (data.length > _this3.state.contents_in_view.length) {
                    previousstate.next = true;
                } else {
                    previousstate.next = false;
                }
                _this3.setState(previousstate);
            }).catch(function (err) {
                _this3.setState({ error: true, loader: false, contents_in_view: err });
            });
        }
    }, {
        key: 'applyfilter',
        value: function applyfilter(props) {
            if (props) {
        ...
        key: 'moreresults',
        value: function moreresults() {
            var _this4 = this;

            var previousstate = this.state;
            previousstate.resultcount = this.state.resultcount + 20;
            previousstate.next = false;
            this.setState(previousstate, function () {
                _this4.applyfilter(_this4.props);
            });
        }
    }, {
        key: 'parseHTML',
        value: function parseHTML(value) {
            return (0, _htmlReactParser2.default)(value);
        }
    }, {
        key: 'shorten_description',
        value: function shorten_description(longstring, charCount) {
            longstring = longstring.substring(0, charCount);
            return longstring.substr(0, Math.min(longstring.length, longstring.lastIndexOf(" "))) + "...";
        }
    }, {
        key: 'createContentUrl',
        value: function createContentUrl(event, i) {
        ...
        key: 'socialshare',
        value: function socialshare(details, url, media) {
        ...
        value: function render() {
            ...
            var renderelement = _react2.default.createElement(
                'div',
                ...
                this.state.loader ? _react2.default.createElement(
                    ...
                    _react2.default.createElement('label', { className: 'loader' })
                ) : this.state.error ? _react2.default.createElement(
                    'div',
                    { className: 'text-center error_info' },
                    'Something Went Wrong. Please try again Later!!'
                ) : this.state.contents_in_view.map(function (e, v) {
                    var current_classname = "blog-card " + (v % 2 !== 0 ? "alt" : ""),
                        image_url = e.contentImageUrl ? e.contentImageUrl : _contentImage2.default,
                        current_imageURL = { background: 'url("' + image_url + '") center no-repeat', backgroundSize: '150px 150px' },
                        contentlink = e.contentLink ? _react2.default.createElement(
                        'a',
                        { rel: 'nofollow, noindex, noopener', className: 'read_more', href: e.contentLink, target: '_blank' },
                        _react2.default.createElement(
                            'b',
                            null,
                            'Read More'
                        ...
                        summary = e.summary ? _react2.default.createElement(
                        'div',
                        { className: 'summary' },
                        _react2.default.createElement(
                            'p',
                            null,
                            _this5.parseHTML(e.summary.title)
                        ),
                        _react2.default.createElement(
                            'p',
                            null,
                            _this5.parseHTML(e.summary.content)
                        ),
                        _react2.default.createElement(
                            'b',
                            null,
                        ...
                        _react2.default.createElement(
                            'i',
                            null,
                            _this5.parseHTML(e.summary.source)
                        )
                    ) : _react2.default.createElement(
                        'div',
                        { className: 'summary' },
                        _react2.default.createElement(
                            ...
                            'People in ',
                            e.countryName,
                            ' have not searched this keyword "',
                            _react2.default.createElement(
                                'b',
                                null,
                                e.title
                            ),
                            '" into any specific website, but still it is one of the most searched content over the web in ',
                            e.countryName,
                            '.'
                        )
                    );
                    return _react2.default.createElement(
                        'div',
                        { className: current_classname, key: v },
                        _react2.default.createElement(
                            'div',
                            { className: 'blog-picture' },
                            _react2.default.createElement('div', { className: 'photo', style: current_imageURL })
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'views' },
                            _react2.default.createElement('span', { className: 'glyphycon-icon view-icon' }),
                            _react2.default.createElement(
                                'span',
                                { className: 'search_traffic' },
                                e.traffic,
                                '+ ',
                                _react2.default.createElement(
                                    'i',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'social_media_w' },
                                    _react2.default.createElement(
                                        'a',
                                        { href: '', onClick: function onClick(event) {
                                                return _this5.createContentUrl(event, v);
                                            }, 'data-action': 'share/whatsapp/share', className: 'social-links' },
                                        ' '
                                    )
                                )
                            ),
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'social_media_p' },
                                    _react2.default.createElement(
                                        'a',
                                        { href: '', onClick: function onClick(event) {
                                                return _this5.createContentUrl(event, v);
                                            }, className: 'social-links pin-it-button', 'count-layout': 'horizontal' },
                                        ' '
                                    )
                                )
                            ),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'description_link', target: '_blank', href: "./desc/" + e._id },
                                _react2.default.createElement(
                                    'h3',
                                    null,
                                    e.title
                ...
                !this.state.error && !this.state.loader && this.state.next ? _react2.default.createElement(
                    'div',
                    { className: 'More-results' },
                    _react2.default.createElement(
                        'span',
                        { className: 'highlight', onClick: this.moreresults },
                        'View More'
                    )
                ) : ""
            );
...
__webpack_require__(/*! ./../assets/css/header.css */ "./app/assets/css/header.css");

var _home_icon = __webpack_require__(/*! ./../assets/images/home_icon.png */ "./app/assets/images/home_icon.png");

var _home_icon2 = _interopRequireDefault(_home_icon);
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: '', onClick: this.movetohome },
                    _react2.default.createElement('img', { src: this.props.logo_url, className: 'header_logo', alt: 'LOGO' })
                ),
                _react2.default.createElement(
                    'a',
                    { href: '', onClick: this.movetohome },
                    _react2.default.createElement('img', { src: '' + _home_icon2.default, style: { width: 50, height: 50, float: "right", margin: 5 }, alt: 'LOGO' })
                )
            );
        }
    }]);
...
var _Blogcontent = __webpack_require__(/*! ./Blogcontent */ "./app/components/Blogcontent.js");
...
var _Ad = __webpack_require__(/*! ./Ad */ "./app/components/Ad.js");

var _Ad2 = _interopRequireDefault(_Ad);

var _trendingscan = __webpack_require__(/*! ./../assets/images/trendingscan.png */ "./app/assets/images/trendingscan.png");

var _trendingscan2 = _interopRequireDefault(_trendingscan);

var _logo = __webpack_require__(/*! ./../assets/images/logo.png */ "./app/assets/images/logo.png");
...
var Homepage = function (_Component) {
	...
	_createClass(Homepage, [{
		key: 'changefilter',
		value: function changefilter(filterdata) {
		...
		value: function getAddress(latitude, longitude) {
			...
			fetch('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + latitude + ',' + longitude + '&key=AIzaSyBn7F5tuFmuhWoC8ntngoGZ2RYjVG9vcWA').then(function (response) {
				return response.json();
			}).then(function (response) {
				// console.log('User\'s Address Data is ', response);
				if (response.results && Object.keys(response.results).length) {
					_this2.setState({ filter: { name: "country", value: response.results[0].address_components[9].long_name } });
				}
			}).catch(function (err) {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_reactHelmet2.default, {
					title: 'Home',
					meta: [{ name: 'fb:page_id', content: '189414828370961' }, { property: 'fb:app_id', content: '462468354180027' }, { property: 'og:url', content: 'http://trendingscan.com/' }, { property: 'og:title', content: 'Trendingscan - Top Trending Searches' }, { property: 'og:type', content: 'article' }, { property: 'og:description', content: 'Explore Top Trending Searches On Internet With Trendingscan' }, { property: 'og:image', content: _trendingscan2.default }, { itemprop: 'name', content: 'Trendingscan - Top Trending Searches' }, { itemprop: 'description', content: 'Explore Top Trending Searches On Internet With Trendingscan' }, { itemprop: 'image', content: _trendingscan2.default }],
					link: [{ rel: "alternate", hreflang: "x-default", href: "http://trendingscan.com/" }, { rel: "canonical", href: "http://trendingscan.com/" }]
				}),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_Header2.default, { logo_url: _logo2.default })
						)
					),
					_react2.default.createElement(
						'div',
						{ className: 'row contentroot' },
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-3 col-xs-3 col-md-3 col-lg-3 hidden-xs body searchoptions' },
							_react2.default.createElement(
								'div',
								{ className: 'col-sm-12 col-xs-12 col-md-12 col-lg-12' },
								_react2.default.createElement(_Search2.default, { filter: this.changefilter }),
								_react2.default.createElement('div', null)
							)
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-6 col-xs-6 col-md-6 col-lg-6 body' },
							_react2.default.createElement(_Blogcontent2.default, { filter: this.state.filter })
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-3 col-xs-3 col-md-3 col-lg-3 hidden-xs body' },
							_react2.default.createElement(
								'div',
								{ className: 'sticky col-sm-3 col-xs-3 col-md-3 col-lg-3' },
								_react2.default.createElement(
									'div',
									null,
									_react2.default.createElement(_Ad2.default, { position: "RIGHT", content: "" })
								)
							)
						)
					)
...
/***/ "./app/components/IndividualBlog.js":
/*!******************************************!*\
  !*** ./app/components/IndividualBlog.js ***!
  \******************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./../assets/css/individualSite.css */ "./app/assets/css/individualSite.css");
...
var IndividualBlog = function (_Component) {
    _inherits(IndividualBlog, _Component);

    function IndividualBlog(props) {
        _classCallCheck(this, IndividualBlog);

        var _this = _possibleConstructorReturn(this, (IndividualBlog.__proto__ || Object.getPrototypeOf(IndividualBlog)).call(this, props));
    ...
    _createClass(IndividualBlog, [{
        ...
        key: '_getParameter',
        value: function _getParameter(identifier) {
        ...
        value: function componentWillMount() {
            ...
            if (this.props.match.params && this.props.match.params.id) {
                fetch('/sites/' + this.props.match.params.id, { headers: {
                    ...
                    if (_this2.ismounted) {
                        if (data.title) {
                            _this2.setState({ error: false, loader: false, content: data });
                        } else {
                            _this2.setState({ error: true, loader: false, content: "Unable to get Page!!" });
                        }
                    }
                }).catch(function (err) {
                    if (_this2.ismounted) {
                        _this2.setState({ error: true, loader: false, content: err });
                    }
                });
            }
        }
        ...
        value: function render() {
            ...
            var contents = this.state.content,
                ...
                contentlink = contents.contentLink && contents.contentLink.length > 0 ? _react2.default.createElement(
                'a',
                { href: contents.contentLink, rel: 'nofollow, noindex, noopener', target: '_blank', className: 'post-link' },
                _react2.default.createElement(
                    'b',
                    null,
                    'Read More...'
                ...
                contentImage = contents.contentImageUrl && contents.contentImageUrl.length > 0 ? contents.contentImageUrl : _contentImage2.default,
                summary = contents.summary && Object.keys(contents.summary).length ? _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'b',
                        null,
                        this.parseHTML(contents.summary.title)
                    )
                ),
                _react2.default.createElement(
                    'p',
                ...
                _react2.default.createElement(
                    ...
                    this.parseHTML(contents.summary.source)
                )
            ) : _react2.default.createElement(
                'div',
                { className: 'blog-content' },
                _react2.default.createElement(
                    'p',
                    null,
                    'People do not visit a specific page in this search but most of the people searched for this keyword in ',
                    _react2.default.createElement(
                        'b',
                        null,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactHelmet.Helmet, {
                    ...
                    meta: [{ name: 'fb:page_id', content: '189414828370961' }, { property: 'fb:app_id', content: '462468354180027' }, { property: 'og:url', content: 'http://trendingscan.com/' }, { property: 'og:title', content: contents.title ? contents.title : contents.countryName + "'s Top Trending Searches - Trendingscan" }, { property: 'og:type', content: 'article' }, { property: 'og:description', content: seo_desc }, { property: 'og:image', content: contents.contentImageUrl && contents.contentImageUrl.length > 0 ? contents.contentImageUrl : _trendingscan2.default }, { itemprop: 'name', content: contents.title ? contents.title : contents.countryName + "'s Top Trending Searches - Trendingscan" }, { itemprop: 'description', content: seo_desc }, { itemprop: 'image', content: contents.contentImageUrl && contents.contentImageUrl.length > 0 ? contents.contentImageUrl : _trendingscan2.default }],
                    link: [{ rel: "alternate", hreflang: "x-default", href: "http://trendingscan.com/" }, { rel: "canonical", href: "http://trendingscan.com/" }]
                }),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'section individual-roundededge' },
                                this.state.loader ? _react2.default.createElement(
                                    'div',
                                    { className: 'loader-wrapper' },
                                    _react2.default.createElement('label', { className: 'loader' })
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    'span',
                                                    { onClick: this.movetohome, className: 'button-home' },
                                                    'Go to Home'
                                                )
                                            )
                                        )
                                    ...
                                    'div',
                                    { className: 'blog-post' },
                                    _react2.default.createElement('input', { type: 'button', value: '<< Back', onClick: this.movetohome, className: 'btn btn-md btn-warning' }),
                                    _react2.default.createElement(
                                        'h1',
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement('img', { src: contentImage, className: 'content-photo', alt: 'Searched Thumbimage' })
                                    ),
                                    _react2.default.createElement(
                                        'h1',
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        null,
                                        _react2.default.createElement('input', { type: 'button', value: '<< Back to Home', className: 'btn btn-md btn-warning', onClick: this.movetohome }),
                                        contentlink
                                    )
                                )
                            )
...
exports.default = IndividualBlog;

/***/ }),

/***/ "./app/components/PrivacyPolicy.js":
/*!*****************************************!*\
  !*** ./app/components/PrivacyPolicy.js ***!
  \*****************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./../assets/css/privacy.css */ "./app/assets/css/privacy.css");
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'sticky header' },
              _react2.default.createElement(_Header2.default, { logo_url: './build/logo.png' })
            )
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h1',
              null,
              'Privacy Policy for Trendingscan'
            ),
            _react2.default.createElement(
              'p',
              null,
              'At Trendingscan, accessible from ',
              _react2.default.createElement(
                'a',
                { href: 'http://trendingscan.com/' },
                'http://trendingscan.com/'
              ),
              ', one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Trendingscan and how we use it.'
            ),
            _react2.default.createElement(
              'p',
              null,
              'If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us through email at senthurathiban94@gmail.com'
            ),
            _react2.default.createElement(
              'h2',
              null,
            ...
            _react2.default.createElement(
              'p',
              null,
              'Like any other website, Trendingscan uses \'cookies\'. These cookies are used to store information including visitors\' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users\' experience by customizing our web page content based on visitors\' browser type and/or other information.'
            ),
            _react2.default.createElement(
              'h2',
              null,
            ...
            _react2.default.createElement(
              'p',
              null,
              'You may consult this list to find the Privacy Policy for each of the advertising partners of Trendingscan.'
            ),
            _react2.default.createElement(
              'p',
              null,
            ...
            _react2.default.createElement(
              'p',
              null,
              'Note that Trendingscan has no access to or control over these cookies that are used by third-party advertisers.'
            ),
            _react2.default.createElement(
              'h2',
              null,
            ...
            _react2.default.createElement(
              'p',
              null,
              'Trendingscan\'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. You may find a complete list of these Privacy Policies and their links here: Privacy Policy Links.'
            ),
            _react2.default.createElement(
              'p',
              null,
            ...
            _react2.default.createElement(
              'p',
              null,
              'Trendingscan does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.'
            ),
            _react2.default.createElement(
              'h2',
              null,
...
var Search = function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function changevalue(event) {
      ...
      this.setState({ country_name: event.target.value }, function () {
        _this2.props.filter({
          name: "country",
          value: _this2.state.country_name
        });
      });
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "h5",
          { className: "heading-filter text-center" },
          "Search Filters"
        ),
        _react2.default.createElement(
          "div",
          ...
          _react2.default.createElement(
            "select",
            { className: "selectinput", onChange: this.changevalue, value: this.state.country_name },
            _react2.default.createElement(
              "option",
              { value: "Argentina" },
              "Argentina"
...
var _template = __webpack_require__(/*! ./../template */ "./app/template.js");
...
__webpack_require__(/*! ./favicon.ico */ "./app/favicon.ico");
